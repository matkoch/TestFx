...
namespace TestFx.Specifications.Implementation.Utilities
{
  ...
  {
    T CreateFor<T> (ISpecK<T> suiteInstance);
  }

  public class SubjectFactory : ISubjectFactory
  {
    public T CreateFor<T> (ISpecK<T> suiteInstance)
    {
    ...
    private object GetArgumentValue (ParameterInfo parameter, ISpecK suiteInstance, IList<FieldInfo> suiteFields)
    {

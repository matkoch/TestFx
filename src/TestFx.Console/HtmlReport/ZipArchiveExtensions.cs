...
namespace TestFx.Console.HtmlReport
{
  ...
  {
    public static void ExtractToDirectory (this ZipArchive source, string destinationDirectoryName, bool overwrite = false)
    {
      var fullName = Directory.CreateDirectory(destinationDirectoryName).FullName;

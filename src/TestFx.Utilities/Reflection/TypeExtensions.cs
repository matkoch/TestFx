...
namespace TestFx.Utilities.Reflection
{
  public static class TypeExtensions
  {
    ...
    {
      return TypeUtility.Instance.GetDirectInterfaces(type);
    }

    public static IEnumerable<Type> GetDirectDerivedTypesOf<T> (this Type type)
    {
      return TypeUtility.Instance.GetDirectDerivedTypes(type, typeof (T));
    }
  }
}
...
{
  public interface ISuiteFile : ICSharpFile, ISuiteDeclarationHolder
  {
  }

  public class SuiteFile : FileBase, ISuiteFile
  {
    private readonly IEnumerable<ISuiteDeclaration> _suiteDeclarations;

    public SuiteFile (IEnumerable<ISuiteDeclaration> suiteDeclarations, ICSharpFile file)
        : base(file)
    {
